(custom-set-variables
 ...
 '(package-selected-packages
   '(ido-completing-read+ ido-vertical-mode flx-ido ido-ubiquitous smex key-chord evil-visualstar evil-surround evil-matchit evil-nerd-commenter evil-leader evil use-package)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(Info-quoted ((t (:background "ivory" :height 100 :family "DejaVu Sans Mono"))))
 '(dired-directory ((t (:inherit default :background "gray" :box (:line-width 2 :color "grey55" :style released-button)))))
